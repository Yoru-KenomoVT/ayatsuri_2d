...
The runtime is the product. It embeds behind a C ABI, so Unity, Unreal, Godot,
Python, JavaScript and anything else that speaks C can drive a puppet. The
editor is how content gets into it.
...
crates/ayatsuri-capi      the C ABI, and the header everything else binds to
